...
Partial Public Class MPK_API
    Public Function CreateMeasurementSetup(description As String, redExposure As Single, greenExposure As Single,
                                           blueExposure As Single, xbExposure As Single, focusDistance As Single,
                                           lensAperture As Single, autoAdjustExposure As Boolean, subframe As Rectangle,
                                           distanceUnit As String, spectralResponseType As String, rotation As Integer) As JObject

        Try
            ttAPI.CreateMeasurementSetup(description, redExposure, greenExposure, blueExposure,
                                         xbExposure, focusDistance, lensAperture, autoAdjustExposure,
                                         subframe, distanceUnit, spectralResponseType, rotation)
            Return JSONSuccess()
